...
import 'package:expede/src/features/auth/register/user/user_register_vm.dart';
    ...
    ref.listen(userRegisterVmProvider, (_, state) {
      switch (state) {
        ...
        case UserRegisterStateStatus.success:
          Navigator.of(context).pushNamedAndRemoveUntil('/auth/register/company', (route) => false);
